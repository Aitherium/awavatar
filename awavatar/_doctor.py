"""Stack-aware `doctor` for awavatar.
...
interesting failures live BETWEEN them. "awavatar is installed" is not the useful
fact -- "awavatar is installed and the thing it pairs with is not" is. This reports
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awavatar needs at runtime, and a
